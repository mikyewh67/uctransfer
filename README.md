...
## Version 1.1 clarity update

- Smaller typography and tighter spacing on phones.
- Outline icons added to all five navigation tabs.
- The Today and Plan screens now separate completed units from the full 66-unit course plan.
- The GE screen now separates areas assigned a course from areas actually completed.
- The current plan explicitly states that it reaches 60 transferable units and maps all 11 Cal-GETC areas.
